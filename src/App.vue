...
div#app
  main
    ...
    Cover
      ...
      h1(slot="gate") 無效預算？<br>揭露108課綱&nbsp五大亂象
    Abstract
      article.article
          ...
          table
            tbody
              ...
              tr
                ...
                td 偏鄉小校開課難
    Chapter
      ChapterBanner(title="掛羊頭賣狗肉^_^明星高中帶頭亂" question="問題點：彈性課程、多元選修" ideal="理想上：國、高中開設多元課程，讓學生探索興趣" truth="現實上：學校掛羊頭賣狗肉，課程變學科加課，喪失多元精神")
      article.article
    ...
    Chapter
      ChapterBanner(title="新名詞讓家長慌^_^補教趁勢賺課綱財" question="問題點：核心素養、高中學習歷程檔案" ideal="理想上：不要「標準化」的工廠學生" truth="現實上：補教換新名詞開班，用「公式」幫孩子鋪路")
      article.article
    ...
    Chapter
      ChapterBanner(title="升學和進度綁架^_^「素養」難落實" question="問題點：素養導向教學" ideal="理想上：學生不只學死背的知識，還學到應對未來挑戰的能力與態度" truth="現實上：教師受限升學與課本進度、教學能力，很難落實")
      article.article
    ...
    Chapter
      ChapterBanner(title="一樣教師兩樣情^_^學生賭運氣" question="問題點：教師心態與素質" ideal="理想上：教師跟上改革趨勢，調整心態與教法" truth="現實上：現實上：教師態度兩極，有教師甚至躲避新課綱")
      article.article
    ...
    Chapter
      ChapterBanner(title="沒有大學幫開課^_^偏鄉、小校怎麼辦？" question="問題點：多元選修課、素養導向" ideal="理想上：用多元課程、生活化命題和教學，打開學生更多可能性" truth="現實上：拉大城鄉間的資源差距")
      article.article
