...
import ShareFb from '@/components/_common/pinhead/ShareFb.vue';
import ShareLine from '@/components/_common/pinhead/ShareLine.vue';
import ShareTwitter from '@/components/_common/pinhead/ShareTwitter.vue';
