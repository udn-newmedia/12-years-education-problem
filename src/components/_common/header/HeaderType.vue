  ...
  <header class="header-bar">
    ...
    <nav
      :class="{
        ...
        'header-bar__nav--hide': !activeFlag || !$store.state.isEnterMainContent,
    ...
    >
      <div class="header-bar__nav__section">
        ...
        >
          <div class="header-bar__anchor-pc__container"
            :class="{'header-bar__anchor-pc__container--hide': !$store.state.isEnterChaosContent}"
          >
    ...
    <nav
      ...
      :class="{
        ...
        'header-bar__anchor-mob--hide': !activeFlag || !$store.state.isEnterChaosContent,
...
import HeaderAnchor from '@/components/_common/header/HeaderAnchor.vue';
import HeaderShare from '@/components/_common/header/HeaderShare.vue';
import HeaderMenu from '@/components/_common/header/HeaderMenu.vue';
import UdnLogo from '@/components/_common/pinhead/UdnLogo.vue';
export default {
  name: 'HeaderType',
